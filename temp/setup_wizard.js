...
function load_frappe_slides() {
	...
	frappe.wiz.welcome = {
		...
		fields: [
			{ fieldname: "language", label: __("Select Your Language"), reqd:1,
				fieldtype: "Select", "default": "español" },
		],
		...
		load_languages: function(slide) {
			frappe.call({
				...
				callback: function(r) {
					...
					language_field.set_input(frappe.wiz.welcome.data.default_language || "español");
	...
	frappe.wiz.region = {
		...
		fields: [
			{ fieldname: "country", label: __("Country"), reqd:1,
				fieldtype: "Select", "default": "Colombia" },
			{ fieldname: "timezone", label: __("Time Zone"), reqd:1,
				fieldtype: "Select", "default": "America/Bogota" },
			{ fieldname: "currency", label: __("Currency"), reqd:1,
				fieldtype: "Select", "default": "COP" },
		],
	...
	frappe.wiz.user= {
		...
		icon: "icon-user",
		fields: [
			{"fieldname": "first_name", "label": __("First Name"), "fieldtype": "Data", "default":get_url_arg('nombreUsuario'),
				reqd:1},
			{"fieldname": "last_name", "label": __("Last Name"), "fieldtype": "Data", "default":get_url_arg('apellidoUsuario')},
			{"fieldname": "email", "label": __("Email Address"), "fieldtype": "Data", "default":get_url_arg('usuario'),
				reqd:1, "description": __("You will use it to Login"), "options":"Email"},
			{"fieldname": "password", "label": __("Password"), "fieldtype": "Password", "default":get_url_arg('clave'),
				reqd:1},
